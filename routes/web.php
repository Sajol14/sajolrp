...
Route::get('/payment-method','FrontendController@paymentMethod')->name('payment-method');
Route::get('/money-back','FrontendController@moneyBack')->name('money-back');
Route::get('/shipping','FrontendController@shipping')->name('shipping');

Route::get('/terms-condition','FrontendController@temsCondition')->name('terms-condition');
