...
@endsection
@section('title','KFS || PRODUCT DETAIL')
										...
										<div class="product-gallery">
											...
											<div class="flexslider-thumbnails">
												<ul class="slides">
													...
													// dd($photo);
													@endphp
                                                    <li data-thumb="{{asset('images/product')}}/{{$product_detail->photo}}" rel="adjustX:10, adjustY:">
                                                        <img src="{{asset('images/product')}}/{{$product_detail->photo}}" alt="{{asset('images/product')}}/{{$product_detail->photo}}">
                                                    </li>
												</ul>
											</div>
											<!-- End Images slider -->
                                ...
                                <div class="single-product">
                                    <div class="product-img">
										<a href="{{route('product-detail',$data->slug)}}">
                                            <img class="default-img" src="{{asset('images/product')}}/{{$data->photo}}" alt="{{asset('images/product')}}/{{$data->photo}}">
                                            <img class="hover-img" src="{{asset('images/product')}}/{{$data->photo}}" alt="{{asset('images/product')}}/{{$data->photo}}">
